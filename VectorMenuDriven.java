			...
			switch(choice)
			{
				...
				case 2:
					...
					for(int iteration=0; iteration < Employee.empCount ;iteration++)
						System.out.println(empObject.get(iteration));
				...
				case 3:
					...
					Enumeration iteration = empObject.elements();
					while(iteration.hasMoreElements())	
						System.out.println(iteration.nextElement());
